    ...
    <div class="my-container my-card" style="margin-top:30px;">
        <div class="my-row-padding" style="margin-top:30px;">
            <div class="my-quarter">
                ...
                <?php echo'<a href="doUpdatestu.php?id='.$id.'" class="my-btn my-block my-padding my-text-white" style="border-radius:5px; width:260px; margin-top:40px; background-color: #770677;">EDIT DETAILS</a>';?>
