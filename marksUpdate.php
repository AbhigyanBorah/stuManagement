        ...
        <div class="my-center">
                    ...
                    <h5>Board: <b> <?php echo $board ?></b><h5>
                      ...
                      $n=mysqli_num_rows($result);
                        ...
                        /*  for($i=1;$i<=$n;$i++)
                      { */
                        $sqlnew=mysqli_query($link,"Select * from academics where bid='$brd' and sem='$sem' and roll='$roll'");
                        while($snew=mysqli_fetch_array($sqlnew))
                        {
                        echo'<tr>';
                        ...
                        echo '</select></td>'; 
                         ...
                         echo'<td><input type="text" name="'.$i."internal".'" value="'.$snew[5].'" class="my-input"></input></td>';
                         echo'<td><input type="text" name="'.$i."final".'" value="'.$snew[6].'" class="my-input"></input></td>';
