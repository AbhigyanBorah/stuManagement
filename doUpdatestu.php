...
<div class="my-content my-white my-card" style="max-width:1000px; opacity:0.95;">
	<form class="my-container" method="post" action="doUpdate.php" id="form1" onsubmit="return validation();">
...
echo '<script>
  ...
  if (confirm("Are you sure you want to update this data?")) {
    document.getElementById("form1").action = "doUpdate.php?id='.$id.'";
  } else {
    document.getElementById("form1").action = "doUpdatestu.php?id='.$id.'";
  }
