...
<div class="my-container my-card-4" style="height: 150px; max-width:1600px; background: linear-gradient(to left, #03553a, #03558a);  border-radius: 0 0 50% 50%/0 0 100% 100%; margin:-17px auto 0;">
        ...
        <a href="homeData.php" class="my-padding"><i class="fa fa-home my-xxlarge nav"></i></a>
    ...
    <div class="my-content">
        ...
        <table id="datatable" class="my-table-all">
                <thead >
                    ...
                    <th class="my-text-white" style="text-align:center;width:20%; background-color: #770677;">Registration No.</th>
                ...
                <tbody>
                    ...
                    <?php
                      include "connect.php";
                      $sql="select * from students where status='r';";
                      ...
                      while($row=mysqli_fetch_array($result))
                          ...
                          echo'<tr class="my-white" style="border-width: 0px;">';
                                ...
                                echo'<td style="width:20%; text-align:center;" class="my-hover-text-red"> <a href="recheckDetails.php?id='.$row[0].'">More Details</a></td>';
