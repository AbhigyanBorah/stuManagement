...
<body class="parallax" style="user-select:none;">
    ...
    <div class="sidenav my-bar-block my-card-4 my-animate-left" style="display:none;" id="mySidebar">
        ...
        <a href="rejectedEntries.php" class="my-bar-item my-large">Rejected Request 
        
  <?php 
			include ("connect.php");
      $str='select * from students where status="r";';
        ...
        <div class="my-container my-xxlarge" style="text-align: center; color: rgb(233, 232, 232); margin-top:10px;">
         <h2 style="font-family: 'Varela Round', sans-serif;">STUDENT MANAGEMENT<h2>
          <h1 style="font-size:55px; font-family: 'Varela Round', sans-serif;">JEC MCA</h1>
            ...
            <!--    
             <div class="my-quarter glass">
                <div class="container">
                 <div class="my-card" style="height: 270px; border-radius: 10px; text-align: center;background: linear-gradient(to top, #03553a, #03558a); ">
                  <div class="overlay" style="border-radius: 10px; ">
                           <?php 
                           $db  = mysqli_connect("localhost", "root", "" ,"new") or die("Can't Connect To Database");
                            $str1=mysqli_query($db,"select COUNT(status) as total FROM students where status= 'r' ");
                            
                            $n1=mysqli_fetch_assoc($str1);
                          ?>
                    <div class="text"><i class="fa fa-user my-xxlarge"></i><br>Total <br> <?php echo $n1['total'] ?> 
                    <br><p><a href="rejectedEntries.php"><button class="my-btn my-hover-white my-round-xxlarge my-wide my-border my-border-white"> View </button></a></p> </div>
                  </div>
                 <h2 style="padding-top: 60px; color:#fff"><i class="fa fa-mortar-board my-xxlarge"></i><br>Rejected<br>Entries</h2>
                 </div>
               </div>
               </div>
