...
<!-- <div class="box" ">
  ...
  <div class="container">
            <div class="forms-container">
                ...
                <form method="post" class="sign-in-form" action="changepwdsql.php" onsubmit="return validation(); autocomplete="off">
                        <h2 class="title">Change Password<br></h2>
                        ...
                        <div class="input-feild" style="display:flex;">
                         ...
                         <button class="my-btn btn solid" type="submit" name="submit" >Proceed</button>
