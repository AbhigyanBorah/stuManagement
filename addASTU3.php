...
?>
        ...
        <div class="my-half">
          ...
          <label class="my-margin-top my-left" style="color:rgb(122, 120, 120)"> Board &nbsp;</label>
            <input name="board" type="text" class="my-input my-animate-input" value="ASTU (3 years)" readonly style="width:40%">
          </p>
          ...
          <button name="submit" onclick="myfunction()" class="my-btn my-block my-margin-bottom my-right my-text-white my-padding" type="submit"
            style="width:40%;margin-left:20%; background-color: #e95a5a;"><span class="my-opacity-off">Save</span>
          </button><br>
        </div>
      </div>
      <br>
...
echo '<script>
  ...
  if (confirm("Are you sure you want to save this data?")) {
    ...
    document.getElementById("form1").action = "addASTU3.php";
  }
