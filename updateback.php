...
<?php
  ...
  if(isset($_GET["id"]))
  {
    ...
    $str1="Select bname from boards where bid='$bid'";
...
<div class="my-content my-white my-card" style="max-width:1300px; opacity:0.95;margin-top:8%;">
	
    	<h1 style="font-family: 'Montserrat', sans-serif; text-align:center; color: #0f2453;margin-top: 80px;"><b> Update Backlog Marks</b></h1>
        ...
        <div class="my-center">
                    ...
                    <h5>Board: <b> <?php echo $board ?></b><h5>
                        ...
                        <div class="my-container" style="margin-top:80px;">
                            <table class="my-table">
                                <thead>
                                 ...
                                 <tbody>
                                 <?php
                                 echo'<form action="upback.php" method="post">';
                      include "connect.php";
                      $sql="Select * from back where roll='$roll' and semester='$sem' and subjectcode='$scode'";
                      $result=mysqli_query($link,$sql);
                      while($row=mysqli_fetch_array($result))
                      {
                      echo'<tr class="my-white" style="border-width: 0px;">';
                      echo'<td class="my-center">'.$row[3].'</td>';
                      echo'<td>'.$row[4].'</td>';
                            ...
                            echo'<td><input type="hidden" readonly name="scode" class="my-input" value="'.$row[3].'"></input></td>';
                            echo'<td><input type="hidden" readonly name="sname" class="my-input" value="'.$row[4].'"></input></td>';
                            echo'<td><input type="hidden" readonly name="roll" class="my-input" value="'.$row[0].'"></input></td>';
                            echo'<td><input type="hidden" readonly name="sem" class="my-input" value="'.$row[1].'"></input></td>';
                            echo'<td><input type="hidden" readonly name="brd" class="my-input" value="'.$row[2].'"></input></td>';
                    ...
                    echo'</tr>';
                      ...
                      echo'</tbody>';   
                        echo'</table>';
                                ...
                                echo '<br>';
                                echo' <button type="submit" name="submit" class="my-hover-indigo my-btn my-blue" style="width:260px;background: linear-gradient(to left, #03553a, #03558a);">Update</button>';
